...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime2.jsxs)(React14.Fragment, {
...
var Portal = React15.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime3.jsx)(React15.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime3.jsx)(React15.Fragment, {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React17.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React17.useEffect(() => {
  ...
  const updateRootElementName = React17.useCallback((instance) => {
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types6.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types6.default.element.isRequired, acceptingRef2);
...
function deepClone(source) {
  if (React23.isValidElement(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React23.isValidElement(source[key])) {
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types7.default.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types8.default.oneOfType([import_prop_types8.default.func, import_prop_types8.default.object]);

// node_modules/@mui/joy/node_modules/@mui/utils/esm/useEnhancedEffect/useEnhancedEffect.js
var React24 = __toESM(require_react());
var useEnhancedEffect2 = typeof window !== "undefined" ? React24.useLayoutEffect : React24.useEffect;
...
function StyledEngineProvider(props) {
  ...
  if (injectFirst || enableCssLayer) {
    return (0, import_jsx_runtime5.jsx)(CacheProvider, {
      value: cache,
      children
    });
  }
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React35.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React37.forwardRef(function Box3(inProps, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(ThemeProvider_default, {
    ...
    children: (0, import_jsx_runtime14.jsx)(ThemeContext.Provider, {
      ...
      children: (0, import_jsx_runtime14.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime13.jsxs)(DefaultPropsProvider_default, {
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React47.useCallback((mode) => {
  ...
  const setColorScheme = React47.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React47.useCallback((event) => {
  ...
  const mediaListener = React47.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React48.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme2 = () => {
    const value = React48.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2(props) {
    ...
    const hasMounted = React48.useRef(false);
    const upperTheme = useTheme3();
    const ctx = React48.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime17.jsxs)(React48.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime17.jsxs)(React48.Fragment, {
...
function createGrid(options = {}) {
  ...
  const Grid2 = React50.forwardRef(function Grid3(inProps, ref) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime19.jsx)(GridOverflowContext.Provider, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LVSAC3FL.js.map
